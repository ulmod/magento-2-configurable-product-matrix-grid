# Magento 2 Configurable Product Matrix/Grid Extension
...
* Display variations/children of configurable products in a Matrix or Grid table
* Display subtotal, grand total, and the total quantity of the selected products
* Display old prices, special price, stock status, and numbers in the matrix/grid table
* Ability to show tier price in the form of tooltip on the matrix/grid table
* Automatically calculate tier price on the matrix/grid table
* Ability to configure matrix/grid table view to all configurable products or separately per specific configurable product
* Support customization options and swatch colors
* Mobile-friendly
* Ability to restrict matrix/grid display per customer group and store views
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/pmatrix-v2.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/pmatrix-v5.png">
